...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // m_exampleCondition.onTrue(new ExampleCommand(m_exampleSubsystem));
    m_driverController.a().onTrue(new StartMotorCommand(m_singleMotorSubsystem));
    // Schedule `exampleMethodCommand` when the Xbox controller's B button is pressed,
    // cancelling on release.
    m_driverController.b().onTrue(new StopMotorCommand(m_singleMotorSubsystem));
  }
